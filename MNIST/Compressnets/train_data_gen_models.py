...
def generate_architectures(max_levels, input_size, output_size, include_bottleneck= True, include_poly = False, include_conv = False, min_levels=3, bit_precision=24): 
    ...
    hidden_nodes_nums["dense"][0] = [i for i in range(25, 100, 25)]
    hidden_nodes_nums["dense"][0].extend([i for i in range(100, 1100, 100)])
...
def main(FLAGS):
    ...
    for exp in experiments: 
        architectures = [[("dense", exp), ("activation", "square"), ("dense", 10)]]
