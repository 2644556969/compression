...
def squash_layers(cryptonets_model, sess):
    ...
    fc_1half_weights = layers[layer_names.index('fc_1half')].get_weights()
    ...
    return (conv1_weights, (squashed_weights, squashed_bias), fc1_weights, fc_1half_weights,
            fc2_weights)
...
def main(FLAGS):
    ...
    (conv1_weights, squashed_weights, fc1_weights, fc_1half_weights, fc2_weights) = weights[0:5]
    ...
    y = model.cryptonets_model_squashed(x, conv1_weights, squashed_weights, fc_1half_weights, 
                                        fc2_weights)
    sess.run(tf.compat.v1.global_variables_initializer())
